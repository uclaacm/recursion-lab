...
function KhanCard(props: KhanCardProps): JSX.Element {
  ...
  return (
    <div className={`khan-card-container ${correct ? 'khan-card-container-correct' : ''}`}>
      ...
      <div className="khan-footer">
        ...
        <div className="tries-left-container">
          ...
          <button className="khan-check-button" onClick={handleClick} disabled={tries == 0 ? true : false}>Check</button>
        </div>
      </div>
      <div>
        {expand &&
