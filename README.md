...
5. Once you're ready, stage and commit your changes using `git commit -am <some-message>`.
6. Move your local branch changes to remote repository using `git push --set-upstream origin <your-branch-name>`.
